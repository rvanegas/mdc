...
REVIEW_ASSESSMENTS_FILENAME = "REVIEW_ASSESSMENTS.md"
...
def build_index(
    ...
    for md_path in sorted(library_path.rglob("*.md")):
        if md_path.name in (MANIFEST_FILENAME, INDEX_FILENAME, KEYS_FILENAME, REFERENCES_FILENAME, RELATED_FILENAME, REVIEW_FILENAME, REVIEW_ASSESSMENTS_FILENAME):
            continue
